  ...
  render() {
    return (
      ...
      <form action="thanks.html" id="fork">
            ...
            <label htmlFor="element_1">First Name </label>
                <div>
            ...
            <label htmlFor="element_2">Last Name </label>
                <div>
            ...
            <label htmlFor="element_5">Email </label>
                <div>
            ...
            <label htmlFor="element_7">Perferred Leaving Time </label>
                <div>
            ...
            <label htmlFor="element_6">Destination </label>
                <div>
